        ...
        <div className="flex gap-1 p-1 bg-muted rounded-xl mb-8 overflow-x-auto">
          {sections.map(s => (
            <button
              ...
              className={`relative flex items-center gap-2 px-4 py-2.5 rounded-lg text-sm font-medium transition-all whitespace-nowrap ${activeSection === s.key ? 'text-foreground' : 'text-muted-foreground hover:text-foreground/70'
                }`}
            >
